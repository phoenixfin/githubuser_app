package com.phoenix.consumerapp.receiver
...
import com.phoenix.consumerapp.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TITLE = "Check Github User!"
    ...
    fun setRepeatingAlarm(context: FragmentActivity?, time: String, message: String) {
